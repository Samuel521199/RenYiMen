...
import { apiDelete } from "@workbench/lib/api";
...
export default function VideosPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      router.push("/auth/signin?callbackUrl=/workbench/videos");
      return;
    }
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => router.push("/workbench/workflows/video")}
        ...
        <div className="mt-6 space-y-3">
          {jobs.map((job) => {
            ...
            return (
              <div
                key={job.id}
                onClick={() => router.push(`/workbench/workflows/video?job_id=${job.id}`)}
