...
import { regenerateKeyframeImage, serializeVideoProject } from "@/services/video-orchestrator/project-service";
...
export async function POST(_req: Request, ctx: RouteContext) {
  ...
  try {
    const project = await regenerateKeyframeImage(session.user.id, projectId, keyframeId);
