...
export const translations = {
  zh: {
    ...
    progressTypical: "常规参考",
    progressPct: (pct: number) => `约 ${Math.round(pct)}%`,
    progressOverdue: "任务已明显超过常规处理时间，但上游仍在运行。请勿重复提交，系统会继续查询并在完成后自动保存结果。",
    progressStillRunning: "上游处理中",
    ...
    successImage: "图片已就绪",
    successVideo: "视频已就绪",
    successModel: "3D 模型已就绪",
    modelDownloadHint: "模型链接有效期为 2 小时，请尽快下载 GLB 文件。",
    modelExportHint: "FBX 资源包包含模型、原始贴图、基础色、法线、粗糙度、金属度及材质映射清单，生成可能需要数分钟。",
    downloadGlbBtn: "下载原始 GLB",
    downloadFbxPackageBtn: "导出 FBX + 贴图",
    downloadTexturesBtn: "导出全部贴图",
    modelExportingBtn: "正在生成资源包…",
    modelExportFailed: "模型资源导出失败，请稍后重试。",
    modelPreviewAriaLabel: "3D 模型交互预览。可拖动旋转、滚轮缩放，方向键旋转，加减键缩放，R 键重置视角。",
    modelPreviewLoading: "正在加载 3D 模型",
    modelPreviewPreparing: "正在准备模型数据…",
    modelPreviewHint: "拖动旋转 · 滚轮缩放 · R 重置",
    modelPreviewReset: "重置视角",
  ...
  en: {
    ...
    progressTypical: "Typical",
    progressPct: (pct: number) => `~${Math.round(pct)}%`,
    progressOverdue: "This task is taking substantially longer than usual, but the upstream service is still processing it. Do not submit a duplicate; the system will keep checking and save the result automatically.",
    progressStillRunning: "Upstream processing",
    ...
    successModel: "3D model ready",
    modelDownloadHint: "The model link expires in 2 hours. Download the GLB file promptly.",
    modelExportHint: "The FBX art package includes the model, original images, base color, normal, roughness, metallic maps, and a material manifest. Export may take several minutes.",
    downloadGlbBtn: "Download original GLB",
    downloadFbxPackageBtn: "Export FBX + textures",
    downloadTexturesBtn: "Export all textures",
    modelExportingBtn: "Building art package…",
    modelExportFailed: "Model asset export failed. Please try again.",
    modelPreviewAriaLabel: "Interactive 3D model preview. Drag to rotate, scroll to zoom, use arrow keys to rotate, plus or minus to zoom, and R to reset the view.",
    modelPreviewLoading: "Loading 3D model",
    modelPreviewPreparing: "Preparing model data…",
    modelPreviewHint: "Drag to rotate · Scroll to zoom · R to reset",
    modelPreviewReset: "Reset view",
