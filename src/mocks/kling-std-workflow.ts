  ...
  fields: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          id: "sound",
          label: "生成音频",
          labelEn: "Generate Audio",
          description: "请求模型同步生成环境音、音效或对白；实际音轨仍取决于上游模型支持情况。",
          descriptionEn: "Request synchronized ambience, sound effects, or speech. The actual audio track still depends on upstream model support.",
          mapping: { nodeId: "input", inputPath: ["sound"] },
          defaultValue: true,
        },
      ],
    },
