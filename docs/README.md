...
`docs/` 只保留当前实现说明、可执行操作手册和稳定的验收基线。代码与文档冲突时，以代码和环境变量模板为准，并及时修正文档。

| 文档 | 用途 |
|---|---|
| [ARCHITECTURE.md](ARCHITECTURE.md) | 当前系统边界、模块关系和维护原则 |
| [runninghub-api.md](runninghub-api.md) | RunningHub 接口及本项目集成规范 |
| [AI-WORKBENCH-INTEGRATION.md](AI-WORKBENCH-INTEGRATION.md) | Workbench 部署、SSO、身份迁移与运维 |
...
已删除的内容包括：已经落地的阶段计划、被当前实现取代的早期设计稿、重复的用户统一分步记录，以及仅复述目录树且已失真的文档。
