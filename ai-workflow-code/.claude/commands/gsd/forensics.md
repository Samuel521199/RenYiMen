...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
