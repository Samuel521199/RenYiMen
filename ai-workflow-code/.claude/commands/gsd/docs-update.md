...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/docs-update.md end-to-end.
