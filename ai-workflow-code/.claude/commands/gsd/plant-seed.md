...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/plant-seed.md end-to-end.
</process>
