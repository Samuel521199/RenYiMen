...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
