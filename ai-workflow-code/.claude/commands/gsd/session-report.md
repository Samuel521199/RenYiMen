...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
