...
<required_reading>
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/verification-overrides.md
...
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/few-shot-examples/verifier.md
