...
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/ios-scaffold.md
...
@/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/references/checkpoints.md**
...
**Use template:** @/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/templates/summary.md
