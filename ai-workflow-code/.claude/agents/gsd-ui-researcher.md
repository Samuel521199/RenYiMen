...
Use template from `/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Volumes/AIWork/projects/ai-image-workbench/.claude/get-shit-done/templates/UI-SPEC.md`
