...
} from "@/lib/activity-production-workflow";
import {
...
import { ACTIVITY_AD_SIZES, ASSET_CATEGORIES } from "@/lib/constants";
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    {state.batchStatus === "completed" && (
                      <div className="flex items-center gap-3">
                        ...
                        <Link href="/gallery" className="text-sm text-emerald-600 underline">
                          {t("查看图库")}
                        </Link>
                      </div>
                    )}
