...
export const NAV_GROUPS = [
  { href: "/dashboard", label: "首页看板", single: true },
  {
    label: "任务中心",
    children: [
      ...
      { label: "转发图生产", href: "/workflows/share" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "转发图指令库", href: "/admin/share-instructions" },
    ],
  },
  { href: "/assets", label: "素材库", single: true },
  {
    label: "标签管理",
    children: [
  ...
  { href: "/review", label: "审核中心", single: true },
  { href: "/gallery", label: "成品图库", single: true },
  { href: "/gallery/video", label: "🎬 视频成品库", single: true },
  { href: "/stats", label: "统计中心", single: true },
  {
    label: "管理后台",
    children: [
