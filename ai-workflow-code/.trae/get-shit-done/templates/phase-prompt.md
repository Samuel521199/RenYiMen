...
<!-- For checkpoint task examples and patterns, see @/Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/references/checkpoints.md -->
...
See `/Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/workflows/verify-phase.md` for verification logic.
