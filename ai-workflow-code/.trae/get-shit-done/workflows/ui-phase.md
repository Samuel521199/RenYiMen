...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/.trae/agents/gsd-ui-checker.md for instructions.
