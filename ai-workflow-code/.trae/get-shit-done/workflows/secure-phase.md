...
```
Task(
  prompt="Read /Volumes/AIWork/projects/ai-image-workbench/.trae/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/AIWork/projects/ai-image-workbench/.trae/get-shit-done/templates/SECURITY.md`
