...
Use template from `/Volumes/AIWork/projects/ai-image-workbench/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Volumes/AIWork/projects/ai-image-workbench/.gemini/get-shit-done/templates/UI-SPEC.md`
