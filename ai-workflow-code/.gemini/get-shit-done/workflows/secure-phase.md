...
```
Task(
  prompt="Read /Volumes/AIWork/projects/ai-image-workbench/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/AIWork/projects/ai-image-workbench/.gemini/get-shit-done/templates/SECURITY.md`
