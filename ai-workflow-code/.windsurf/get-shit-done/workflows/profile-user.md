...
Key references:
- @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/ui-brand.md (display patterns)
- @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/agents/gsd-user-profiler.md (profiler agent definition)
- @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md" "/Volumes/AIWork/projects/ai-image-workbench/.windsurf/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/user-profiling.md`
...
Reference: @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .windsurf/rules" -- "Add profile to /Volumes/AIWork/projects/ai-image-workbench/.windsurf/.windsurf/rules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Volumes/AIWork/projects/ai-image-workbench/.windsurf/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Volumes/AIWork/projects/ai-image-workbench/.windsurf/.windsurf/rules"
...
```bash
BACKUP_PATH="/Volumes/AIWork/projects/ai-image-workbench/.windsurf/USER-PROFILE.backup.md"
```
...
Your profile:    /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Volumes/AIWork/projects/ai-image-workbench/.windsurf/commands/gsd/dev-preferences.md
  ✓ .windsurf/rules section       .windsurf/rules
  ✓ Global .windsurf/rules        /Volumes/AIWork/projects/ai-image-workbench/.windsurf/.windsurf/rules
```
