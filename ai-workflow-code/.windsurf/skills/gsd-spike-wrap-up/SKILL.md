...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/spike-wrap-up.md
...
<process>
Execute the spike-wrap-up workflow from @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/spike-wrap-up.md end-to-end.
Preserve all workflow gates (auto-include, feature-area grouping, skill synthesis, .windsurf/rules routing line, intelligent next-step routing).
</process>
