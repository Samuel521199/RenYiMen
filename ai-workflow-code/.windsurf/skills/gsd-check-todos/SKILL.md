...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/check-todos.md`.
