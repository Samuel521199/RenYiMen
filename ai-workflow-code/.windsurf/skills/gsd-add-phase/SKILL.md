...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/add-phase.md`.
