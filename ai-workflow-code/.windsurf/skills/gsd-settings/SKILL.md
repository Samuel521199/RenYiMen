...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/workflows/settings.md`.
