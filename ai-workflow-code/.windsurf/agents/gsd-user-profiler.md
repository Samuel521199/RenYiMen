...
<reference>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/user-profiling.md` to load:
