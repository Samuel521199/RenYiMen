...
<required_reading>
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/AIWork/projects/ai-image-workbench/.windsurf
                  → checks /Volumes/AIWork/projects/ai-image-workbench/.windsurf/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done
                  → writes to /Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/hooks/
...
@/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/thinking-models-debug.md
...
- Read @/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/common-bug-patterns.md
