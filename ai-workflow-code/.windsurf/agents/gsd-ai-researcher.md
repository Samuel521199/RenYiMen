...
<required_reading>
Read `/Volumes/AIWork/projects/ai-image-workbench/.windsurf/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
