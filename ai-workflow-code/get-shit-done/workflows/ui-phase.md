...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/AIWork/projects/ai-image-workbench/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/agents/gsd-ui-checker.md for instructions.
