...
```
Task(
  prompt="Read /Volumes/AIWork/projects/ai-image-workbench/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/AIWork/projects/ai-image-workbench/get-shit-done/templates/VALIDATION.md`
