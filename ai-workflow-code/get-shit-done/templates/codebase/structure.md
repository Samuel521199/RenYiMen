...
- Usage: Reference from command with `@/Volumes/AIWork/projects/ai-image-workbench/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Volumes/AIWork/projects/ai-image-workbench/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Volumes/AIWork/projects/ai-image-workbench/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
