...
Reference full template: `/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/templates/state.md`.
