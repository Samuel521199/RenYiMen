...
```
Task(
  prompt="Read /Volumes/AIWork/projects/ai-image-workbench/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/templates/SECURITY.md`
