...
@/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/references/ui-brand.md
@/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/references/revision-loop.md
@/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/Volumes/AIWork/projects/ai-image-workbench/.kilo/get-shit-done/references/tdd.md to all eligible tasks:
