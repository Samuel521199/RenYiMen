...
<required_reading>
Read `/Volumes/AIWork/projects/ai-image-workbench/.opencode/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
