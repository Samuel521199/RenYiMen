...
```bash
INIT=$(node "/Volumes/AIWork/projects/ai-image-workbench/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Volumes/AIWork/projects/ai-image-workbench/.opencode/get-shit-done/templates/spec.md.
