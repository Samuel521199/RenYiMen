...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node /Volumes/AIWork/projects/ai-image-workbench/.opencode/get-shit-done/bin/gsd-tools.cjs
