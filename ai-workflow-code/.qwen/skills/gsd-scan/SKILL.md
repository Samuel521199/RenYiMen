...
<execution_context>
@/Volumes/AIWork/projects/ai-image-workbench/.qwen/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @/Volumes/AIWork/projects/ai-image-workbench/.qwen/get-shit-done/workflows/scan.md end-to-end.
</process>
