...
- **Global scope**: `/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/notes/`)
...
2. Glob `/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/notes/` — works in any directory
