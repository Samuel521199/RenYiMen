...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/.codebuddy/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/AIWork/projects/ai-image-workbench/.codebuddy/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/AIWork/projects/ai-image-workbench/.codebuddy/agents/gsd-ui-checker.md for instructions.
