...
- Usage: Reference from command with `@/Volumes/AIWork/projects/ai-image-workbench/.codebuddy/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Volumes/AIWork/projects/ai-image-workbench/.codebuddy/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Volumes/AIWork/projects/ai-image-workbench/.codebuddy/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
